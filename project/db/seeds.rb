...
animal3 = Animal.new({'profile' => "TBC", 'name' => "Radavest",'species' => "Griffon", 'breed' => "Long-Clawed", 'admission_date' => "1422-11-15", 'ready_to_adopt' => "TRUE", 'honour_level' => 9, 'adopted' => "FALSE"})
...
owner3 = Owner.new({'name' => "Sir Dominic the Calm",'profile' => "English", 'address' => "Heavenly Vaults", 'species_pref' => "Griffon", 'honour_level' => 10, 'is_dead' => "FALSE"})
